  ...
  return <div className="min-h-screen bg-[var(--theme-background,#141414)] text-white overflow-x-hidden">
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 relative z-10">
        ...
        <div className="flex flex-col lg:grid lg:grid-cols-3 lg:gap-6">
          ...
          <div id="video-player" className="lg:col-span-2 relative overflow-hidden w-full bg-black aspect-video mb-4 lg:mb-0 rounded-none">
            {embedHtml ? <div style={{
            paddingBottom: '56.25%'
          }} dangerouslySetInnerHTML={{
            __html: embedHtml
          }} className="w-full h-0 relative mx-0 px-0 py-0 rounded-sm" /> : <div className="flex items-center justify-center h-full bg-gray-900 aspect-video">
